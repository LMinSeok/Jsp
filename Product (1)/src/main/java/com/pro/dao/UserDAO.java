...
public class UserDAO {
	...
	public void insertUser(UsersVO vo) {
		...
		String sql = "INSERT INTO users (NUM, ID, USERNAME, EMAIL, PASS, REGISTRATION_DATE, IS_ADMIN, ADDR, addr2) "
	...
	public UsersVO selectUser(int num) {
	...
	public UsersVO selectOnUser(String id) {
	...
	public void updateUser(UsersVO vo) {
		...
		String sql = "update users set username=?, email=?, pass=?, addr=?, addr2=? where num=?";
